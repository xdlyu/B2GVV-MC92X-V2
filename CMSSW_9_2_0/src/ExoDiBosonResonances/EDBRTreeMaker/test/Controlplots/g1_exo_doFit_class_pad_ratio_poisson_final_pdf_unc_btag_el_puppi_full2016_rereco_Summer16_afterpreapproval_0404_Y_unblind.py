...
#        else:
        ...
        self.file_Directory="data_2017B_afterapproval/";
        ...
        if options.control==1:
            self.file_data = (self.channel+"_PKUTree_17B.root");
        else: 
    ...
    def ControlPlots(self):
        ...
        cut="jet_tau2tau1_puppi<0.55 && MET_et>80 && (CategoryID==1 || CategoryID==-1 || CategoryID==2 || CategoryID==-2|| CategoryID==4 || CategoryID==-4) && m_lvj> 600 && m_lvj<5000 &&((jet_mass_puppi_corr>40 && jet_mass_puppi_corr<105)||(jet_mass_puppi_corr>135&&jet_mass_puppi_corr<150)) && passFilter_HBHE>0 && passFilter_GlobalHalo>0 && passFilter_HBHEIso>0 && passFilter_ECALDeadCell>0 && passFilter_GoodVtx>0 && passFilter_EEBadSc>0 && passFilter_badMuon>0 && passFilter_badChargedHadron>0 && l_pt> %s && MET_et>%s"%(self.lpt_cut, self.MET_cut)
        self.Make_Controlplots(cut,"preselection");

#        cut="MET_et>80 && (CategoryID==3 || CategoryID==-3) && m_lvj> 100 && m_lvj<4000 && jet_mass_puppi_corr>40 && jet_mass_puppi_corr<150 && passFilter_HBHE>0 && passFilter_GlobalHalo>0 && passFilter_HBHEIso>0 && passFilter_ECALDeadCell>0 && passFilter_GoodVtx>0 && passFilter_EEBadSc>0 && passFilter_badMuon>0 && passFilter_badChargedHadron>0 && l_pt>%s && MET_et>%s"%(self.lpt_cut, self.MET_cut) 
#        self.Make_Controlplots(cut,"TopControl",1);

    ######## ++++++++++++++
    def Make_Controlplots(self,cut,tag, TTBarControl=0):
        self.make_controlplot("m_lvj",cut,tag,88,600,5000,"m_{WW} (GeV)","Events/(50 GeV)",0, TTBarControl );
        self.make_controlplot("massVhadJEC",cut,tag,23,40,155,"m_{jet} (GeV)","Events/(5 GeV)",0 , TTBarControl);
        self.make_controlplot("W_pt",cut,tag,30,200, 800,"W_pt (GeV)","Events/(20 GeV)",0 , TTBarControl);
        self.make_controlplot("l_pt",cut,tag,26,0, 520,"l_pt (GeV)","Events/(20 GeV)",0 , TTBarControl);
        self.make_controlplot("jetAK8_pt",cut,tag,30,200, 800,"jetAK8_pt (GeV)","Events/(20 GeV)",0 , TTBarControl);
        self.make_controlplot("l_eta",cut,tag,20,-2.5,2.5,"l_eta","Events(0.25)",0 , TTBarControl);
        self.make_controlplot("jet_eta",cut,tag,20,-2.5,2.5,"jet_eta","Events(0.25)",0 , TTBarControl);
        self.make_controlplot("MET_et",cut,tag,30,0,600,"MET_et (GeV)","Events/(20 GeV)",0 , TTBarControl);
        self.make_controlplot("met",cut,tag,30,0,600,"MET (GeV)","Events/(20 GeV)",0 , TTBarControl);
        self.make_controlplot("nPV",cut,tag,20,0,40,"nPV","Events/(2)",0 , TTBarControl);
        self.make_controlplot("tau21",cut,tag,25,0,1,"#tau_{21}","Events/(0.04)",0 , TTBarControl);
        self.make_controlplot("nbtag",cut,tag,5,-0.5,4.5,"number of b-jets","Events",0 , TTBarControl);
        self.make_controlplot("jet_mass_puppi",cut,tag,23,40,155,"m_{jet} (GeV)","Events/(5 GeV)",0 , TTBarControl);
        self.make_controlplot("jet_mass_puppi_un",cut,tag,23,40,155,"m_{jet} (GeV)","Events/(5 GeV)",0 , TTBarControl);
        self.make_controlplot("jet_mass_puppi_corr",cut,tag,23,40,155,"m_{jet} (GeV)","Events/(5 GeV)",0 , TTBarControl);
        self.make_controlplot("jet_tau2tau1_puppi",cut,tag,25,0,1,"#tau_{21}","Events/(0.04)",0 , TTBarControl);
        self.make_controlplot("jet_mass_pruned",cut,tag,23,40,155,"m_{jet} (GeV)","Events/(5 GeV)",0 , TTBarControl);
        self.make_controlplot("mtVlepnew",cut,tag,61,0,305,"mT_{Wlep} (GeV)","Events/(5 GeV)",0 , TTBarControl);
        self.make_controlplot("MTVlep",cut,tag,61,0,305,"mT_{Wlep} (GeV)","Events/(5 GeV)",0 , TTBarControl);
        self.make_controlplot("jetAK8puppi_sdcorr",cut,tag,23,40,155,"m_{jet} (GeV)","Events/(5 GeV)",0 , TTBarControl);
        self.make_controlplot("jet_pt_puppi",cut,tag,30,200, 800,"jetAK8_pt (GeV)","Events/(20 GeV)",0 , TTBarControl);
        self.make_controlplot("jetAK8puppi_eta",cut,tag,20,-2.5,2.5,"jet_eta","Events(0.25)",0 , TTBarControl);
        self.make_controlplot("candMassJEC",cut,tag,32,400,2000,"m_{WW} (GeV)","Events/(50 GeV)",0, TTBarControl );

#        self.make_controlplot("TMath.Sqrt(2*l_pt*pfMET*(1.0-TMath.Cos(l_phi-pfMETPhi)))",cut,tag,21,0,420,"mT_{Wlep} (GeV)","Events/(20 GeV)",0 , TTBarControl);
 
    ######## ++++++++++++++
    def make_controlplot(self,variable,cut,tag,nbin,min,max,xtitle="",ytitle="",logy=0 , TTBarControl=0):
        tmp_lumi=self.GetLumi()
        #tmp_signal_scale=200
        tmp_signal_scale=10
	weight_mc_forSignal="weight*%s*%s"%(tmp_lumi, tmp_signal_scale);
        ...
        if self.channel=="mu": tmp_WJets_scale=0.76#0.98
        if self.channel=="el": tmp_WJets_scale=1.00
        if self.channel=="mu": tmp_TTBar_scale=0.56#0.79
        if self.channel=="el": tmp_TTBar_scale=0.95
        ...
        weightcut_mc_forSignal_up="(%s)*(%s)*btagweight_up/btagweight_center"%(weight_mc_forSignal,cut);
        weightcut_mc_forV_up="(%s)*(%s)*btagweight_up/btagweight_center"%(weight_mc_forV,cut);
        weightcut_mc_forT_up="(%s)*(%s)*btagweight_up/btagweight_center"%(weight_mc_forT,cut);
        weightcut_mc_forG_up="(%s)*(%s)*btagweight_up/btagweight_center"%(weight_mc_forG,cut);
        weightcut_mc_forWJets_up="(%s)*(%s)*btagweight_up/btagweight_center"%(weight_mc_forWJets,cut);
        weightcut_mc_forTTBar_up="(%s)*(%s)*btagweight_up/btagweight_center"%(weight_mc_forTTBar,cut);
        #weightcut_data="%s"%(cut);
        weightcut_mc_forSignal_down="(%s)*(%s)*btagweight_down/btagweight_center"%(weight_mc_forSignal,cut);
        weightcut_mc_forV_down="(%s)*(%s)*btagweight_down/btagweight_center"%(weight_mc_forV,cut);
        weightcut_mc_forT_down="(%s)*(%s)*btagweight_down/btagweight_center"%(weight_mc_forT,cut);
        weightcut_mc_forG_down="(%s)*(%s)*btagweight_down/btagweight_center"%(weight_mc_forG,cut);
        weightcut_mc_forWJets_down="(%s)*(%s)*btagweight_down/btagweight_center"%(weight_mc_forWJets,cut);
        weightcut_mc_forTTBar_down="(%s)*(%s)*btagweight_down/btagweight_center"%(weight_mc_forTTBar,cut);
        #weightcut_data="%s"%(cut);
        ...
        hist_Signal_up =TH1D("hist_Signal_up","hist_Signal_up"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_Signal_up.Sumw2();
        hist_WJets_up=TH1D("hist_WJets_up","hist_WJets_up"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_WJets_up.Sumw2();
        hist_TTbar_up=TH1D("hist_TTbar_up","hist_TTbar_up"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_TTbar_up.Sumw2();
        hist_STop_up =TH1D("hist_STop_up","hist_STop_up"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_STop_up.Sumw2();
        hist_VV_up   =TH1D("hist_VV_up","hist_VV_up"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_VV_up.Sumw2();
        hist_TotalMC_up =TH1D("hist_TotalMC_up","hist_TotalMC_up"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_TotalMC_up.Sumw2();

        hist_Signal_down =TH1D("hist_Signal_down","hist_Signal_down"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_Signal_down.Sumw2();
        hist_WJets_down=TH1D("hist_WJets_down","hist_WJets_down"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_WJets_down.Sumw2();
        hist_TTbar_down=TH1D("hist_TTbar_down","hist_TTbar_down"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_TTbar_down.Sumw2();
        hist_STop_down =TH1D("hist_STop_down","hist_STop_down"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_STop_down.Sumw2();
        hist_VV_down   =TH1D("hist_VV_down","hist_VV_down"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_VV_down.Sumw2();
        hist_TotalMC_down =TH1D("hist_TotalMC_down","hist_TotalMC_down"+";%s;%s"%(xtitle,ytitle),nbin,min,max);
        hist_TotalMC_down.Sumw2();
        ...
        hstack_TotalMC_up = THStack("hstack_TotalMC_up","hstack_TotalMC_up"+";%s;%s"%(xtitle,ytitle))
        if TTBarControl==0:
            hstack_TotalMC_up.Add(hist_STop_up);
            hstack_TotalMC_up.Add(hist_TTbar_up);
            hstack_TotalMC_up.Add(hist_VV_up);
            hstack_TotalMC_up.Add(hist_WJets_up);
        else:
            hstack_TotalMC_up.Add(hist_WJets_up);
            hstack_TotalMC_up.Add(hist_VV_up);
            hstack_TotalMC_up.Add(hist_STop_up);
        ...
        hstack_TotalMC_down = THStack("hstack_TotalMC_down","hstack_TotalMC_down"+";%s;%s"%(xtitle,ytitle))
        if TTBarControl==0:
            hstack_TotalMC_down.Add(hist_STop_down);
            hstack_TotalMC_down.Add(hist_TTbar_down);
            hstack_TotalMC_down.Add(hist_VV_down);
            hstack_TotalMC_down.Add(hist_WJets_down);
        else:
            hstack_TotalMC_down.Add(hist_WJets_down);
            hstack_TotalMC_down.Add(hist_VV_down);
            hstack_TotalMC_down.Add(hist_STop_down);
        ...
        hist_Signal_up.SetLineColor(self.color_palet["Signal"]); hist_Signal_up.SetFillColor(self.color_palet["Signal"]); hist_Signal_up.SetFillStyle(0);hist_Signal_up.SetLineWidth(2);
        hist_WJets_up.SetLineColor(kBlack); hist_WJets_up.SetFillColor(self.color_palet["WJets"]);
        hist_TTbar_up.SetLineColor(kBlack); hist_TTbar_up.SetFillColor(self.color_palet["TTbar"]);
        hist_STop_up.SetLineColor(kBlack); hist_STop_up.SetFillColor(self.color_palet["STop"]);
        hist_VV_up.SetLineColor(kBlack); hist_VV_up.SetFillColor(self.color_palet["VV"]);

        hist_Signal_down.SetLineColor(self.color_palet["Signal"]); hist_Signal_down.SetFillColor(self.color_palet["Signal"]); hist_Signal_down.SetFillStyle(0);hist_Signal_down.SetLineWidth(2);
        hist_WJets_down.SetLineColor(kBlack); hist_WJets_down.SetFillColor(self.color_palet["WJets"]);
        hist_TTbar_down.SetLineColor(kBlack); hist_TTbar_down.SetFillColor(self.color_palet["TTbar"]);
        hist_STop_down.SetLineColor(kBlack); hist_STop_down.SetFillColor(self.color_palet["STop"]);
        hist_VV_down.SetLineColor(kBlack); hist_VV_down.SetFillColor(self.color_palet["VV"]);
        ...
        tree_Signal_up =TChain("PKUTree");  tree_Signal_up.Add(self.file_Directory+self.file_signal);
        tree_WJets_up  =TChain("PKUTree");tree_WJets_up.Add(self.file_Directory+self.file_WJets0_mc);
        tree_TTbar_up  =TChain("PKUTree");tree_TTbar_up.Add(self.file_Directory+self.file_TTbar_mc);
        tree_STop_up   =TChain("PKUTree");  tree_STop_up.Add(self.file_Directory+self.file_STop_mc);
        tree_VV_up     =TChain("PKUTree");      tree_VV_up.Add(self.file_Directory+self.file_VV_mc);

        tree_Signal_down =TChain("PKUTree");  tree_Signal_down.Add(self.file_Directory+self.file_signal);
        tree_WJets_down  =TChain("PKUTree");tree_WJets_down.Add(self.file_Directory+self.file_WJets0_mc);
        tree_TTbar_down  =TChain("PKUTree");tree_TTbar_down.Add(self.file_Directory+self.file_TTbar_mc);
        tree_STop_down   =TChain("PKUTree");  tree_STop_down.Add(self.file_Directory+self.file_STop_mc);
        tree_VV_down     =TChain("PKUTree");      tree_VV_down.Add(self.file_Directory+self.file_VV_mc);
        ...
        tree_Signal_up.Draw("%s >> hist_Signal_up"%(variable), weightcut_mc_forSignal_up);
        tree_WJets_up.Draw("%s >> hist_WJets_up"%(variable), weightcut_mc_forWJets_up);
        tree_TTbar_up.Draw("%s >> hist_TTbar_up"%(variable), weightcut_mc_forTTBar_up);
        tree_STop_up.Draw("%s >> hist_STop_up"%(variable), weightcut_mc_forT_up);
        tree_VV_up.Draw("%s >> hist_VV_up"%(variable), weightcut_mc_forV_up);

        tree_Signal_down.Draw("%s >> hist_Signal_down"%(variable), weightcut_mc_forSignal_down);
        tree_WJets_down.Draw("%s >> hist_WJets_down"%(variable), weightcut_mc_forWJets_down);
        tree_TTbar_down.Draw("%s >> hist_TTbar_down"%(variable), weightcut_mc_forTTBar_down);
        tree_STop_down.Draw("%s >> hist_STop_down"%(variable), weightcut_mc_forT_down);
        tree_VV_down.Draw("%s >> hist_VV_down"%(variable), weightcut_mc_forV_down);

        hist_TotalMC.Add(hist_WJets); hist_TotalMC.Add(hist_TTbar); hist_TotalMC.Add(hist_STop); hist_TotalMC.Add(hist_VV);
        hist_TotalMC_up.Add(hist_WJets_up); hist_TotalMC_up.Add(hist_TTbar_up); hist_TotalMC_up.Add(hist_STop_up); hist_TotalMC_up.Add(hist_VV_up);
        hist_TotalMC_down.Add(hist_WJets_down); hist_TotalMC_down.Add(hist_TTbar_down); hist_TotalMC_down.Add(hist_STop_down); hist_TotalMC_down.Add(hist_VV_down);

        canvas_controlplot = TCanvas("canvas_controlplot"+variable,"canvas_controlplot"+variable, 600,600);
        fPads1 = TPad("pad1", "Run2", 0.00, 0.28, 1.00, 1.00);
        fPads2 = TPad("pad2", "", 0.00, 0.00, 1.00, 0.28);
        #canvas_controlplot.cd();
        fPads1.SetBottomMargin(0.0);
        ...
        gr_MCStat.SetTitle("Sys.");
        gr_MCStat.SetFillColor(1);
        gr_MCStat.SetFillStyle(3013);
        count=0
        while (count<hist_TotalMC.GetNbinsX()):
            gr_MCStat.SetPoint(count*2  , hist_TotalMC.GetBinCenter(count+1)-0.5*hist_TotalMC.GetBinWidth(count+1), hist_TotalMC.GetBinContent(count+1)+TMath.Sqrt(hist_TotalMC.GetBinError(count+1)*hist_TotalMC.GetBinError(count+1)+0.0025*hist_TotalMC.GetBinContent(count+1)*hist_TotalMC.GetBinContent(count+1)+(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_up.GetBinContent(count+1))*(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_up.GetBinContent(count+1))+0.0025*hist_WJets.GetBinContent(count+1)*hist_WJets.GetBinContent(count+1)+0.0004*hist_TTbar.GetBinContent(count+1)*hist_TTbar.GetBinContent(count+1)+(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_down.GetBinContent(count+1))*(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_down.GetBinContent(count+1))));
            gr_MCStat.SetPoint(count*2+1, hist_TotalMC.GetBinCenter(count+1)+0.5*hist_TotalMC.GetBinWidth(count+1), hist_TotalMC.GetBinContent(count+1)+TMath.Sqrt(hist_TotalMC.GetBinError(count+1)*hist_TotalMC.GetBinError(count+1)+0.0025*hist_TotalMC.GetBinContent(count+1)*hist_TotalMC.GetBinContent(count+1)+(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_up.GetBinContent(count+1))*(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_up.GetBinContent(count+1))+0.0025*hist_WJets.GetBinContent(count+1)*hist_WJets.GetBinContent(count+1)+0.0004*hist_TTbar.GetBinContent(count+1)*hist_TTbar.GetBinContent(count+1)+(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_down.GetBinContent(count+1))*(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_down.GetBinContent(count+1))));
            count=count+1;
        count_re=0
        while (count>0):
            gr_MCStat.SetPoint(hist_TotalMC.GetNbinsX()*2+count_re*2  , hist_TotalMC.GetBinCenter(count)+0.5*hist_TotalMC.GetBinWidth(count), hist_TotalMC.GetBinContent(count)-TMath.Sqrt(hist_TotalMC.GetBinError(count)*hist_TotalMC.GetBinError(count)+0.0025*hist_TotalMC.GetBinContent(count)*hist_TotalMC.GetBinContent(count)+(hist_TotalMC.GetBinContent(count)-hist_TotalMC_down.GetBinContent(count))*(hist_TotalMC.GetBinContent(count)-hist_TotalMC_down.GetBinContent(count))+0.0025*hist_WJets.GetBinContent(count)*hist_WJets.GetBinContent(count)+0.0004*hist_TTbar.GetBinContent(count)*hist_TTbar.GetBinContent(count)+(hist_TotalMC.GetBinContent(count)-hist_TotalMC_up.GetBinContent(count))*(hist_TotalMC.GetBinContent(count)-hist_TotalMC_up.GetBinContent(count))));
            gr_MCStat.SetPoint(hist_TotalMC.GetNbinsX()*2+count_re*2+1, hist_TotalMC.GetBinCenter(count)-0.5*hist_TotalMC.GetBinWidth(count), hist_TotalMC.GetBinContent(count)-TMath.Sqrt(hist_TotalMC.GetBinError(count)*hist_TotalMC.GetBinError(count)+0.0025*hist_TotalMC.GetBinContent(count)*hist_TotalMC.GetBinContent(count)+(hist_TotalMC.GetBinContent(count)-hist_TotalMC_down.GetBinContent(count))*(hist_TotalMC.GetBinContent(count)-hist_TotalMC_down.GetBinContent(count))+0.0025*hist_WJets.GetBinContent(count)*hist_WJets.GetBinContent(count)+0.0004*hist_TTbar.GetBinContent(count)*hist_TTbar.GetBinContent(count)+(hist_TotalMC.GetBinContent(count)-hist_TotalMC_up.GetBinContent(count))*(hist_TotalMC.GetBinContent(count)-hist_TotalMC_up.GetBinContent(count))));
            count_re=count_re+1
            count=count-1;
...
#        Extratext = TLatex(0.28, 0.96, "Preliminary");
#        Extratext.SetNDC(); 
...
#        Extratext.SetNDC(); Extratext.SetTextSize(0.032); Extratext.SetTextFont(52); Extratext.SetTextAlign(11); Extratext.SetLineWidth(2); Extratext.Draw();
        ...
        theLeg.AddEntry(hist_data, "Data W#rightarrow e#nu","ep");
        ...
        theLeg.AddEntry(hist_Signal, "G_{Bulk} M_{G}=1000 GeV (#times %s)"%(tmp_signal_scale),"L");
        ...
        thisYmin = 0.5;
        thisYmax = 1.5;
        nsigma_x = TVectorD(hist_data.GetNbinsX());
        nsigma_y = TVectorD(hist_data.GetNbinsX());
        nsigma_x_error = TVectorD(hist_data.GetNbinsX());
        nsigma_y_error = TVectorD(hist_data.GetNbinsX());
        for ibin in range(0,hist_data.GetNbinsX(),1):
            Data=hist_data.GetBinContent(ibin + 1);
            Bkg =hist_TotalMC.GetBinContent(ibin + 1); 
            eData = hist_data.GetBinError(ibin + 1);
            eBkg = hist_TotalMC.GetBinError(ibin + 1);
            x = hist_data.GetBinCenter(ibin + 1);
            diff = Data - Bkg;
            sigma = TMath.Sqrt((eData * eData) + (eBkg * eBkg));
            if (sigma != 0.0 and Bkg != 0.0):nsigma_x[ibin] = x;nsigma_y[ibin] = Data / Bkg;nsigma_y_error[ibin] = sigma/Bkg;nsigma_x_error[ibin] = 0;
            else:nsigma_x[ibin] = +999999;nsigma_y[ibin] = 0;
        
        if nsigma_x.GetNoElements() != 0:
           nsigmaGraph =TGraphErrors(nsigma_x, nsigma_y, nsigma_x_error, nsigma_y_error);
           nsigmaGraph.SetTitle("");
           nsigmaGraph.GetYaxis().SetRangeUser(thisYmin, thisYmax);
           nsigmaGraph.GetYaxis().SetTitle("Data/MC");
           nsigmaGraph.GetYaxis().SetTitleOffset(0.5);
           nsigmaGraph.GetYaxis().SetTitleSize(0.12);
           nsigmaGraph.GetYaxis().SetLabelSize(0.12);
           nsigmaGraph.GetXaxis().SetTitle("%s"%(xtitle));
           nsigmaGraph.GetXaxis().SetTitleSize(0.12);
           nsigmaGraph.GetXaxis().SetLimits(hist_TotalMC.GetXaxis().GetXmin() , hist_TotalMC.GetXaxis().GetXmax());
           nsigmaGraph.GetXaxis().SetRangeUser(hist_TotalMC.GetXaxis().GetXmin() , hist_TotalMC.GetXaxis().GetXmax());
           nsigmaGraph.GetXaxis().SetTitleOffset(0.9);
           nsigmaGraph.GetXaxis().SetLabelSize(0.12);
        ...
        gr_MCStat_pad=TGraph(hist_TotalMC.GetNbinsX()*4);
        gr_MCStat_pad.SetName("MCStat_pad");
        gr_MCStat_pad.SetTitle("MC Stat_pad");
        gr_MCStat_pad.SetFillColor(1);
        gr_MCStat_pad.SetFillStyle(3008);
        count=0
        while (count<hist_TotalMC.GetNbinsX()):
            if hist_TotalMC.GetBinContent(count+1) != 0:
                 gr_MCStat_pad.SetPoint(count*2  , hist_TotalMC.GetBinCenter(count+1)-0.5*hist_TotalMC.GetBinWidth(count+1), 1.0+TMath.Sqrt(hist_TotalMC.GetBinError(count+1)*hist_TotalMC.GetBinError(count+1)+0.0025*hist_TotalMC.GetBinContent(count+1)*hist_TotalMC.GetBinContent(count+1)+(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_up.GetBinContent(count+1))*(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_up.GetBinContent(count+1))+0.0025*hist_WJets.GetBinContent(count+1)*hist_WJets.GetBinContent(count+1)+0.0004*hist_TTbar.GetBinContent(count+1)*hist_TTbar.GetBinContent(count+1)+(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_down.GetBinContent(count+1))*(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_down.GetBinContent(count+1)))/hist_TotalMC.GetBinContent(count+1));
                 gr_MCStat_pad.SetPoint(count*2+1, hist_TotalMC.GetBinCenter(count+1)+0.5*hist_TotalMC.GetBinWidth(count+1), 1.0+TMath.Sqrt(hist_TotalMC.GetBinError(count+1)*hist_TotalMC.GetBinError(count+1)+0.0025*hist_TotalMC.GetBinContent(count+1)*hist_TotalMC.GetBinContent(count+1)+(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_up.GetBinContent(count+1))*(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_up.GetBinContent(count+1))+0.0025*hist_WJets.GetBinContent(count+1)*hist_WJets.GetBinContent(count+1)+0.0004*hist_TTbar.GetBinContent(count+1)*hist_TTbar.GetBinContent(count+1)+(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_down.GetBinContent(count+1))*(hist_TotalMC.GetBinContent(count+1)-hist_TotalMC_down.GetBinContent(count+1)))/hist_TotalMC.GetBinContent(count+1));
            else:
                 gr_MCStat_pad.SetPoint(count*2  , hist_TotalMC.GetBinCenter(count+1)-0.5*hist_TotalMC.GetBinWidth(count+1), 1.0);
                 gr_MCStat_pad.SetPoint(count*2+1, hist_TotalMC.GetBinCenter(count+1)+0.5*hist_TotalMC.GetBinWidth(count+1), 1.0);
            count=count+1;
        count_re=0
        while (count>0):
            if hist_TotalMC.GetBinContent(count) != 0:
                 gr_MCStat_pad.SetPoint(hist_TotalMC.GetNbinsX()*2+count_re*2  , hist_TotalMC.GetBinCenter(count)+0.5*hist_TotalMC.GetBinWidth(count), 1.0-TMath.Sqrt(hist_TotalMC.GetBinError(count)*hist_TotalMC.GetBinError(count)+0.07*hist_TotalMC.GetBinContent(count)*0.07*hist_TotalMC.GetBinContent(count)+(hist_TotalMC.GetBinContent(count)-hist_TotalMC_down.GetBinContent(count))*(hist_TotalMC.GetBinContent(count)-hist_TotalMC_down.GetBinContent(count))+0.0025*hist_WJets.GetBinContent(count)*hist_WJets.GetBinContent(count)+0.0004*hist_TTbar.GetBinContent(count)*hist_TTbar.GetBinContent(count)+(hist_TotalMC.GetBinContent(count)-hist_TotalMC_up.GetBinContent(count))*(hist_TotalMC.GetBinContent(count)-hist_TotalMC_up.GetBinContent(count)))/hist_TotalMC.GetBinContent(count));
                 gr_MCStat_pad.SetPoint(hist_TotalMC.GetNbinsX()*2+count_re*2+1, hist_TotalMC.GetBinCenter(count)-0.5*hist_TotalMC.GetBinWidth(count), 1.0-TMath.Sqrt(hist_TotalMC.GetBinError(count)*hist_TotalMC.GetBinError(count)+0.07*hist_TotalMC.GetBinContent(count)*0.07*hist_TotalMC.GetBinContent(count)+(hist_TotalMC.GetBinContent(count)-hist_TotalMC_down.GetBinContent(count))*(hist_TotalMC.GetBinContent(count)-hist_TotalMC_down.GetBinContent(count))+0.0025*hist_WJets.GetBinContent(count)*hist_WJets.GetBinContent(count)+0.0004*hist_TTbar.GetBinContent(count)*hist_TTbar.GetBinContent(count)+(hist_TotalMC.GetBinContent(count)-hist_TotalMC_up.GetBinContent(count))*(hist_TotalMC.GetBinContent(count)-hist_TotalMC_up.GetBinContent(count)))/hist_TotalMC.GetBinContent(count));
            else:
                 gr_MCStat_pad.SetPoint(hist_TotalMC.GetNbinsX()*2+count_re*2  , hist_TotalMC.GetBinCenter(count)+0.5*hist_TotalMC.GetBinWidth(count), 1.0);
                 gr_MCStat_pad.SetPoint(hist_TotalMC.GetNbinsX()*2+count_re*2+1, hist_TotalMC.GetBinCenter(count)-0.5*hist_TotalMC.GetBinWidth(count), 1.0);
            count_re=count_re+1
            count=count-1;
        print count, count_re

        gr_MCStat_pad.Draw("F");
...
#        datacard_out.write( "\nCMS_xww_btagger lnN - - %0.3f %0.3f %0.3f"%(self.channel, 1+self.btag_scale_uncertainty, 1+self.btag_scale_uncertainty, 1+self.btag_scale_uncertainty ) );
    ...
    def banner4Plot(self, iswithpull=0):
      ...
      if iswithpull:
       if self.channel=="el":
        banner = TLatex(0.3,0.96,("CMS \emph{Preliminary}, %.1f fb^{-1} at #sqrt{s} = 13TeV"%(self.GetLumi())));
...
#        banner = TLatex(0.18,0.96,"CMS                                             L = 19.7 fb^{-1} at #sqrt{s} = 8 TeV");
       ...
       if self.channel=="el":
        banner = TLatex(0.22,0.96,("CMS                                                                %.1f fb^{-1} at #sqrt{s} = 13TeV"%(self.GetLumi())));
#        banner = TLatex(0.18,0.96,"CMS                                         L = 19.7 fb^{-1} at #sqrt{s} = 8 TeV");
       if self.channel=="mu":
        banner = TLatex(0.22,0.96,("CMS                                                                %.1f fb^{-1} at #sqrt{s} = 13TeV"%(self.GetLumi())));
        #banner = TLatex(0.18,0.96,"CMS                                         L = 19.7 fb^{-1} at #sqrt{s} = 8 TeV");
...
objName ==objName_before ):
    ...
    def GetLumi(self):
        #if self.channel=="el":   return 35.867;
        #elif self.channel=="mu": return 35.867;
        if self.channel=="el":   return 5.21;
        elif self.channel=="mu": return 5.21;
...
def control_single(channel):
    ...
    control_single_sb_correction("method1",channel, "BulkGravWW1000",500,1300,40,150,400,1000,"ErfExp_v1")
