...
#        else:
        ...
        self.file_Directory="/afs/cern.ch/user/l/lewang/Xudong/CMSSW_8_0_26_patch1/src/VVcode_full/Controlplots/data_2017B_afterapproval/";
...
#        self.make_controlplot("TMath.Sqrt(2*l_pt*pfMET*(1.0-TMath.Cos(l_phi-pfMETPhi)))",cut,tag,21,0,420,"mT_{Wlep} (GeV)","Events/(20 GeV)",0 , TTBarControl);
    ...
    def make_controlplot(self,variable,cut,tag,nbin,min,max,xtitle="",ytitle="",logy=0 , TTBarControl=0):
        ...
        if self.channel=="mu": tmp_WJets_scale=0.97
        if self.channel=="el": tmp_WJets_scale=0.97
        if self.channel=="mu": tmp_TTBar_scale=0.92
